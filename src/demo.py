...
class DemoVSCodeSpoofer:
    ...
    def show_main_menu(self) -> str:
        ...
        self.console.print("1. List system information")
        self.console.print("2. List network information")
        self.console.print("3. Use spoofing features")
    ...
    def show_before_after_comparison(self, selected_features: list[str]) -> None:
        ...
        before_table = Table(
            title="CURRENT VALUES", show_header=True, header_style="bold yellow"
        )
        ...
        after_table = Table(
            title="PLANNED VALUES", show_header=True, header_style="bold green"
        )
        ...
        try:
            ...
            while True:
                ...
                if choice == "1":
                    ...
                    self.console.print(
                        "[bold cyan]Step 1: Feature Selection[/bold cyan]"
                    )
                    ...
                    self.console.print()
                    self.console.print(
                        "[bold cyan]Step 2: Before/After Comparison[/bold cyan]"
                    )
                    ...
                    self.console.print()
                    self.console.print(
                        "[bold cyan]Step 3: Execution Progress[/bold cyan]"
                    )
